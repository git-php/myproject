...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到聚鹿！[<a href="login.html">登录</a>] [<a href="register.html">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="index.html"><img src="/Public/Home/images/logo.png" alt="聚鹿商城"></a></h2>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_ft">
			<a href="/index.php/Home/Cart/index3"><span>提交订单</span></a>
