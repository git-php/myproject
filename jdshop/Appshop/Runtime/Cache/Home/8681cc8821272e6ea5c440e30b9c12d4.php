...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/index.php">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > <?php echo $goodsinfo['g_name']?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?php echo $goodsinfo['g_name']?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo IMG_URL.$goodsinfo['g_img']?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo IMG_URL.$goodsinfo['g_img']?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
						<?php for($i=0;$i<5;$i++):?>
								<li <?php echo ($i==0)?'class="cur"':''?>>
									<a <?php echo $i==0? 'class="zoomThumbActive"' : ''?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo IMG_URL.$goodsinfo['g_img']?>',largeimage: '<?php echo IMG_URL.$goodsinfo['g_img']?>'}"><img src="<?php echo IMG_URL.$goodsinfo['g_img']?>"></a>
								</li>
						<?php endfor;?>	
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo $goodsinfo['g_sn']?></li>
						<li class="market_price"><span>定价：</span><em>￥<?php echo $goodsinfo['shop_price']?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo $goodsinfo['promote_price']?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo date('Y-m-d',$goodsinfo['g_addtime'])?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="/index.php/Home/Cart/addcart" method="post" class="choose">
						<ul>
							<li class="product">
								<dl>
									<dt>颜色：</dt>
									<dd>
										...
										<input type="hidden" name="goods_id" value="<?php echo $goodsinfo['g_id']?>" />
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="after_sale mt15 none detail_div">
						...
						<div>
							<h3>服务承诺：</h3>
							<p>本商城向您保证所售商品均为正品行货，聚鹿自营商品自带机打发票，与商品一起寄送。凭质保证书及聚鹿商城发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由本商城联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。本商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！</p> 
						...
						<div>
							<h3>权利声明：</h3>
							<p>本商城上的所有商品信息、客户评价、商品咨询、网友讨论等内容，是聚鹿商城重要的经营资源，未经许可，禁止非法转载使用。</p>
