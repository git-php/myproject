...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			...
			<div class="user fl">
				...
				<?php  if(session('?user')){ $user=session('user'); echo "<li>您好， 【 .$user. 】</li>"; }else{ echo "<li>您好，请[<a href='/index.php/Home/User/login'>登录</a>] </li>"; } ?>
						</div>
	...
	<div class="main w1210 bc mt10">
		<div class="crumb w1210">
			<h2><strong>我的个人中心 </strong><span>> 账户信息</span></h2>
		</div>
			...
			<div class="user_bd mt10">
				<form action="" method="post">
					<ul>
						<li>
							<label for="">头像：</label>
							<img src='/Public/Home/images/user1.gif' />
						</li>
						<li>
							<label for="">用户名：</label>
							<strong>bai@juulu.com</strong>
						</li>
						<li>
							<label for="">账户余额：</label>
							<strong>￥340555.03元</strong>
						</li>
						<li>
							<label for="">真实名字：</label>
							<strong>东方不败</strong>
						</li>
						<li>
							<label for="">手机：</label>
							<strong>18811888505</strong>
						</li>
						<li>
							<label for="">注册时间：</label>
							<strong>2015年4月15日14:05:45</strong>
						</li>
						<li>
							<label for="">昵称：</label>
							<strong>小贱鸡</strong>
						...
						<li>
							...
							<strong>广东省深圳市福田区华强北华强广场B楼B座B房</strong>
						</li>
