...
<div class="main-div">
<form method="post" action="/index.php/Admin/News/edit/id/6" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
<table cellspacing="1" cellpadding="3" width="100%">
  <tbody><tr>
    <td class="label">文章标题</td>
    <td><input type="text" name="title" maxlength="60" size="50" value="<?php echo $data['title']?>"><span class="require-field">*</span></td>
  </tr>
  <tr>
    <td class="label">文章作者</td>
    <td><input type="text" name="author" maxlength="60"  value="<?php echo $data['author']?>"></td>
  </tr>
  
  <tr>
    <td class="label">文章内容</td>
    <td><textarea name="content" id="b_desc" cols="60" rows="4"><?php echo $data['content']?></textarea></td>
  </tr>
