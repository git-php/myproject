...
<div class="main-div">
  <form action="/index.php/Admin/Attribute/add" method="post" name="theForm">
  <table width="100%" id="general-table">
     ...
     <!--  <tr id="attrGroups" style="display: none;">
      ...
      <tr>
        ...
        <td>
          <input type="text" name="a_sort" value="50">
          <span class="require-field">*</span>        </td>
      </tr>
      <tr>
        <td class="label">可选值列表：</td>
        <td>
          <textarea name="a_value" cols="30" rows="5" disabled=""></textarea>
          多个属性用逗号,隔开
        </td>
      </tr>
      <tr>
