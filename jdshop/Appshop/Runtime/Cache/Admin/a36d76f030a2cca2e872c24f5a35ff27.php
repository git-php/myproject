...
<div id="header-div">
	...
	<div id="submenu-div">
		...
		<div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
			当前IP： <?php echo $_SERVER['REMOTE_ADDR']?>，欢迎您 【 <?php echo (session('admin')); ?> 】，时间:<?php echo $time;?>
			<a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu">清除缓存</a>
			<a href="/index.php/Admin/admin/logout" onclick="return confirm('真的退出么？')" target="_top" class="fix-submenu">退出</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
	</div>
