...
<h1>
<span class="action-span"><a href="/index.php/Admin/Goodstype/index">商品类型列表</a></span>
  ...
  <form action="" method="post" name="theForm" onsubmit="return validate();">
    <table cellspacing="1" cellpadding="3" width="100%">
      <tbody><tr>
        ...
        <td><input type="text" name="type_name" value="<?php echo $data['type_name']?>" size="40">
        <span class="require-field">*</span></td>
      </tr>
      <tr style="display:none">
        <td class="label">状态:</td>
        <td><input type="radio" name="" value="0">&nbsp;禁用&nbsp;<input type="radio" name="" value="1" checked="">&nbsp;启用&nbsp;</td>
      </tr>
      <tr style="display:none">
