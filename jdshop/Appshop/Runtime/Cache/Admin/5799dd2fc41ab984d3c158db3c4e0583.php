...
<form method="post" action="/index.php/Admin/Admin/login" name='theForm'>
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
      <td colspan="2" align="right"><img src="/index.php/Admin/Admin/captcha" width="145" height="30" alt="CAPTCHA" border="1" onclick= this.src="/index.php/Admin/Admin/captcha/_="+Math.random() style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
      </td>
      </tr>
