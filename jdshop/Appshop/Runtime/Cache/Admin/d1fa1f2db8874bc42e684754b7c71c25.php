...
<head>
	...
	<style type="text/css">
		...
		.explode {background: url(/Public/Admin/images/menu_minus.gif) no-repeat 0px 3px; font-weight: bold;}
		.collapse { background: url(/Public/Admin/images/menu_plus.gif) no-repeat 0px 3px; font-weight: bold;}
		.menu-item { background: url(/Public/Admin/images/menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="/Public/Admin/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
			</span>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="/index.php/Admin/Goods/index" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="/index.php/Admin/Goods/add" target="main-frame">添加新商品</a></li>
						  <li class="menu-item"><a href="/index.php/Admin/Category/index" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="/index.php/Admin/Comment/index" target="main-frame">用户评论</a></li>
						  <li class="menu-item"><a href="/index.php/Admin/Brand/index" target="main-frame">商品品牌</a></li>
						  <li class="menu-item"><a href="/index.php/Admin/Goodstype/index" target="main-frame">商品类型</a></li>
						  <li class="menu-item"><a href="/index.php/Admin/Attribute/index" target="main-frame">商品属性</a></li>
				...
				<li class="explode" key="04_order" name="menu"> 订单管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="__GROUP__/Order/index" target="main-frame">订单列表</a></li>
				...
				<li class="collapse" key="07_content" name="menu"> 文章管理        
					<ul style="display: none;">
						<li class="menu-item"><a href="/index.php/Admin/News/index" target="main-frame">文章分类</a></li>
						<li class="menu-item"><a href="/index.php/Admin/News/index" target="main-frame">文章列表</a></li>
						<li class="menu-item"><a href="/index.php/Admin/News/add" target="main-frame">添加文章</a></li>
