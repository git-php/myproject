...
<?php foreach($data as $v):?>
			<tr>
				...
				<td align="center">
				  <a href="/index.php/Admin/Attribute/index" title="属性列表">属性列表</a>  | 
				  <a href="/index.php/Admin/Goodstype/edit/id/<?php echo $v['type_id']?>" title="编辑">编辑</a> |  
				  <a href="/index.php/Admin/Goodstype/del/id/<?php echo $v['type_id']?>" onclick="return confirm('真的删除么？')" title="移除">移除</a>
				</td>
			</tr>
<?php endforeach;?>
